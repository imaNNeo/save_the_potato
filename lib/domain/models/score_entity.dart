...
class OfflineScoreEntity extends ScoreEntity {
  ...
  OfflineScoreEntity({required this.score});

  OfflineScoreEntity copyWith({int? score}) =>
      OfflineScoreEntity(score: score ?? this.score);

  @override
  Map<String, dynamic> toJson() => {'score': score, 'type': _type};

  factory OfflineScoreEntity.fromJson(Map<String, dynamic> json) =>
      OfflineScoreEntity(score: json['score']);
...
class OnlineScoreEntity extends ScoreEntity {
  ...
  @override
  List<Object?> get props => [score, userId, nickname, isMine, rank];
}
